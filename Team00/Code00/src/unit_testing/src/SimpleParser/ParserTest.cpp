...
TEST_CASE("SimpleParser::Parser") {
    SECTION("read") {
        ...
        REQUIRE(var_name_node->get_type() == NodeType::VAR_NAME);
    ...
    SECTION("call") {
        ...
        REQUIRE(proc_name_node->get_type() == NodeType::PROC_NAME);
    ...
    SECTION("assign") {
        SECTION("assign to variable") {
            ...
            REQUIRE(left_var_name_node->get_type() == NodeType::VAR_NAME);
            ...
            REQUIRE(right_var_name_node->get_type() == NodeType::VAR_NAME);
        ...
        SECTION("assign to constant") {
            ...
            REQUIRE(const_value_node->get_type() == NodeType::CONST_VALUE);
        ...
        SECTION("assign to arithmetic operation") {
            ...
            REQUIRE(arith_node->get_type() == NodeType::ARITHMETIC);
    ...
    SECTION("if") {
        ...
        REQUIRE(cond_node->get_type() == NodeType::CONDITIONAL);
    ...
    SECTION("arithmetic") {
        ...
        SECTION("left-associative") {
            ...
            REQUIRE(right_const_value_node->get_type() == NodeType::CONST_VALUE);
            ...
            REQUIRE(child_arith_node->get_type() == NodeType::ARITHMETIC);
            ...
            REQUIRE(middle_var_name_node->get_type() == NodeType::VAR_NAME);
    ...
    SECTION("conditional") {
        ...
        SECTION("negation") {
            ...
            REQUIRE(inner_cond_node->get_type() == NodeType::CONDITIONAL);
            REQUIRE(inner_cond_node->get_value() == ">");
            REQUIRE(inner_cond_node->get_children().size() == 2);
            REQUIRE(inner_cond_node->get_child(0)->get_type() == NodeType::VAR_NAME);
            REQUIRE(inner_cond_node->get_child(1)->get_type() == NodeType::CONST_VALUE);
        ...
        SECTION("and/or") {
            ...
            REQUIRE(left_cond_node->get_type() == NodeType::CONDITIONAL);
            REQUIRE(left_cond_node->get_value() == ">");
            REQUIRE(left_cond_node->get_children().size() == 2);
            REQUIRE(left_cond_node->get_child(0)->get_type() == NodeType::VAR_NAME);
            REQUIRE(left_cond_node->get_child(1)->get_type() == NodeType::CONST_VALUE);

            auto right_cond_node = cond_node->get_child(1);
            REQUIRE(right_cond_node->get_type() == NodeType::CONDITIONAL);
            REQUIRE(right_cond_node->get_value() == "<=");
            REQUIRE(right_cond_node->get_children().size() == 2);
            REQUIRE(right_cond_node->get_child(0)->get_type() == NodeType::CONST_VALUE);
            REQUIRE(right_cond_node->get_child(1)->get_type() == NodeType::VAR_NAME);
        ...
        SECTION("deeply nested") {
            ...
            REQUIRE(right_cond_node->get_value() == ">");
            REQUIRE(right_cond_node->get_children().size() == 2);
            REQUIRE(right_cond_node->get_child(0)->get_type() == NodeType::VAR_NAME);
            REQUIRE(right_cond_node->get_child(1)->get_type() == NodeType::CONST_VALUE);
            ...
            REQUIRE(left_inner_cond_node->get_type() == NodeType::CONDITIONAL);
            ...
            REQUIRE(left_inner_left_cond_node->get_type() == NodeType::ARITHMETIC);
            REQUIRE(left_inner_left_cond_node->get_value() == "+");
            REQUIRE(left_inner_left_cond_node->get_children().size() == 2);
            REQUIRE(left_inner_left_cond_node->get_child(0)->get_type() == NodeType::VAR_NAME);
            REQUIRE(left_inner_left_cond_node->get_child(1)->get_type() == NodeType::CONST_VALUE);

            auto left_inner_right_cond_node = left_inner_cond_node->get_child(1);
            REQUIRE(left_inner_right_cond_node->get_type() == NodeType::ARITHMETIC);
            REQUIRE(left_inner_right_cond_node->get_value() == "*");
            REQUIRE(left_inner_right_cond_node->get_children().size() == 2);
            REQUIRE(left_inner_right_cond_node->get_child(0)->get_type() == NodeType::VAR_NAME);
            REQUIRE(left_inner_right_cond_node->get_child(1)->get_type() == NodeType::CONST_VALUE);
    ...
    SECTION("procedure") {
        ...
        REQUIRE(procedure_node->get_type() == NodeType::PROCEDURE);
    ...
    SECTION("program") {
        ...
        REQUIRE(program_node->get_type() == NodeType::PROGRAM);
        REQUIRE(program_node->get_children().size() == 1);
        REQUIRE(program_node->get_child(0)->get_type() == NodeType::PROCEDURE);
