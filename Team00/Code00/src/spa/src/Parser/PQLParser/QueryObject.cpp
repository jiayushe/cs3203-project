...
void QueryObject::set_has_such_that(bool new_has_such_that) { has_such_that_cl = new_has_such_that; }

void QueryObject::set_has_pattern(bool new_has_pattern) { has_pattern_cl = new_has_pattern; }

void QueryObject::set_such_that(const SuchThat &new_such_that_cl) { such_that_obj = new_such_that_cl; }
