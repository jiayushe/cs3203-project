...
void QueryObject::set_selection(std::string selection) { this->selection = selection; }

void QueryObject::set_has_such_that(bool has_such_that) { this->has_such_that_cl = has_such_that; }

void QueryObject::set_has_pattern(bool has_pattern) { this->has_pattern_cl = has_pattern; }

void QueryObject::set_such_that(SuchThat such_that_cl) { this->such_that_obj = such_that_cl; }

void QueryObject::set_pattern(Pattern pattern_cl) { this->pattern_obj = pattern_cl; }
