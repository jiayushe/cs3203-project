...
namespace SimpleExtractor {
    ...
    private:
        static void extract_modify_relationship_from_stmt_list(KnowledgeBase::PKB pkb, std::string proc_name, SimpleParser::Node* stmt_list);
        static void extract_modify_relationship_from_stmt(KnowledgeBase::PKB pkb, std::string proc_name, SimpleParser::Node* stmt);
        static void extract_modify_relationship_from_read_stmt(KnowledgeBase::PKB pkb, std::string proc_name, SimpleParser::Node* stmt);
        static void extract_modify_relationship_from_assign_stmt(KnowledgeBase::PKB pkb, std::string proc_name, SimpleParser::Node* stmt);
    };
