...
public:
    ...
    std::unordered_set<int> get_called_by_statements();
    ...
    std::unordered_set<std::string> get_direct_callers();
    ...
    std::unordered_set<std::string> get_callers();
    ...
    std::unordered_set<std::string> get_direct_callees();
    ...
    std::unordered_set<std::string> get_callees();
...
private:
    ...
    std::unordered_set<int> called_by_statements;
    std::unordered_set<std::string> modifies;
    std::unordered_set<std::string> uses;
    std::unordered_set<std::string> direct_callers;
